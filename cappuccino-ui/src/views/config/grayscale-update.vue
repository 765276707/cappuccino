<template>
    ...
    <el-dialog 
        ...
        <el-form  ref="FORM" :model="form" :rules="rule" label-width="120px">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="灰度规则" prop="rules">
                        <el-input  type="textarea" :rows="5" v-model="form.rules" placeholder="请输入灰度规则，多个规则用英文字符逗号隔开" style="width: 100%"/>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
...
export default {
    ...
    methods: {
        ...
        async submit() {
            ...
            let response = null;
            // 更新
            response = await this.$API.grayscale.release(this.form)
            this.$emit('success')
